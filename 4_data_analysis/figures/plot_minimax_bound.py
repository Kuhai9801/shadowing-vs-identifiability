...
Usage:
  ...
  python -m figures.plot_minimax_bound --success_csv 6_results/blockA_success.csv --solver newton --K 64 --metric single_error

  # Coverage (set-valued top-K mitigation beyond the theorem's scope):
  python -m figures.plot_minimax_bound --success_csv 6_results/blockA_success.csv --solver newton --K 64 --metric best_error
